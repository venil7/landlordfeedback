...
INSERT INTO `comments` VALUES (1,3,'Horrid.','2011-01-25 22:26:09',2,'Feedback');
...
INSERT INTO `entries` VALUES (1,10,2,2,'This house is hands down the worst place I have ever lived.  When I viewed the flat, Grace failed to mention that her unemployed partner, who also lives there, would be doing serious renovations to the flat. All she said is that he would be painting at some point.  I put up with him using very loud electric sanders on the stairs, sometimes until 10pm at night, while also blaring techno music.  All of this took place on my xmas break.  Also, I had no access to the kitchen for 5 days, never once being told in advance about it either, through my whole xmas break.  I had to spend my money eating my meals out.  I was also told I would have internet.  They turned that off as well and claimed it wasn\'t in my contract.  They then turned it back on after tyring to resolve things.  I then decided to leave, so I let Grace know.  She withheld my deposit which was Ã‚Â£630.  Since then, the last week of my stay, they turned off my wifi again, they said I couldn\'t use my bathroom as her partner was retiling it.  He never once did anything in it.  Just removed the showerhead to be petty.  The place was filthy.  My bedroom was constantly covered in dust due to him sanding all the time and wasn\'t even considerate enough to block the bottom of my door from the dust.  My bathroom was constantly covered in dust as well.  I couldnt\'t walk through the house without being covered in dust.  I was constantly breathing in paint remover as well which caused me to constantly cough and have headaches.  All of this and no warnings what so ever.  These people are horrible. DO NOT RENT FROM THIS PERSON. I only put one star because it won\'t let me chose no stars.',1,'2011-01-24 21:59:52'),(2,1,3,2,'suauy\\;DUFI\\U',5,'2011-01-24 22:14:34'),(3,11,1,2,'Lovely property rent included all bills. One issue We had during our stay someone was able to enter apartment during my and my partners absence and took money (secret stash) from cupboard. when we noticed that we have changed door lock and never had any other issue since. Nice propertu to rent out but be aware and never leave valuables unattended.',4,'2011-01-25 21:34:30'),(4,11,3,2,'nice 1 bedroom apartment,when we moved in we had everything we needed including towels and bed sheets. ',5,'2011-01-28 19:38:18'),(5,1,3,2,'Very nice and responsive Landlord. ',5,'2011-01-28 19:38:56'),(6,3,3,2,'Everything was good except neighbours..their apartment was opposite ours. we\'ve bought laptop on ebay  delivery guy left our parcel with neighbours on ground floor and left delivery notice for our apartment in their post box by mistake. they didn\'t even bother come to us. this took about 1 month to find out what exactly has happened. In other  words these people are thieves!!!\r\n',1,'2011-01-28 19:39:39'),(7,1,4,6,'Worst landlord.  He didn\'t return my deposit. ',1,'2011-04-14 21:52:45');
...
INSERT INTO `entrytypes` VALUES (1,'Landlord',NULL),(2,'Agency',NULL),(3,'Neighbors',NULL),(4,'Neighborhood',NULL),(5,'Area',NULL),(6,'Local Council',NULL),(7,'Local shops/facilities',NULL),(8,'Garden',NULL),(9,'Bills',NULL),(10,'Other',NULL),(11,'Accomodation',NULL);
...
INSERT INTO `feedbacks` VALUES (1,118,2,24,'2009-05-14','Property Boutique','Property Boutique',1,'2011-01-25 21:25:25','2011-01-25 21:25:25'),(2,122,3,6,'2011-01-24','Grace Sarfarazi','Private',1,'2011-01-25 22:11:30','2011-01-25 22:11:30'),(3,123,2,6,'2011-05-31','Mr.Dolman','N/A',1,'2011-01-28 19:36:38','2011-01-28 19:36:38'),(4,124,6,6,'2011-04-14','Jacek Tomiak','none',0,'2011-04-14 21:47:37','2011-04-14 21:47:37'),(5,126,7,30,'2011-05-10','kkkjkj ','jgtvoyuu',0,'2011-05-29 08:17:24','2011-05-29 08:17:24');
...
INSERT INTO `users` VALUES (1,'1033864170','Art','Deineka','fighting_1r1sh@yahoo.ie',NULL,'2010-12-22 23:08:55','2010-12-22 23:08:55'),(2,'837178900','Svetlana','Kleimenova','mstemper1@gmail.com',NULL,'2010-12-28 00:13:03','2010-12-28 00:13:03'),(3,'539046207','Alexandria','Nelson','aluxembourg@gmail.com',NULL,'2011-01-25 13:21:19','2011-01-25 13:21:19'),(4,'100001529467645','Simrat','Kaur','kaur.simrat@gmail.com',NULL,'2011-03-12 04:24:43','2011-03-12 04:24:43'),(5,'1836768818','Chimit','Undefined','chimit@gmail.com',NULL,'2011-03-30 01:16:09','2011-03-30 01:16:09'),(6,'618041661','Womble','Merciless','weasellook@hotmail.co.uk',NULL,'2011-04-14 21:46:37','2011-04-14 21:46:37'),(7,'1357861339','Фёдор','Зима','art2k@mail.ru',NULL,'2011-05-29 08:16:16','2011-05-29 08:16:16'),(8,'100000910555667','今入','庸介','imairi@gmail.com',NULL,'2011-05-29 14:41:59','2011-05-29 14:41:59');
...
-- Dump completed on 2011-06-01 19:42:41
